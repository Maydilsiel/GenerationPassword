namespace generatorpassword
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Нажмите на кнопку \"Создать пароль\", чтобы сгенерировать надежный пароль.\r\n\r\n\r\nЧто" +
    "бы скопировать сгенерированный пароль, сначала выберите его из списка,\r\nа потом " +
    "нажмите \"Скопировать пароль\".";
            ...
            this.toolStripButton1.Text = "Сгенерировать пароль";
            ...
            this.label2.Text = "Журнал сгенерированных паролей";
            ...
            this.toolStripButton2.Text = "Скопировать пароль";
